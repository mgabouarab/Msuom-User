...
//                    }
//                } catch {
//                    let valueObject  = try decoder.decode(APIGenericResponse<User>.self, from: value)
...
//                                    }
//
//                                    let vc = VerificationCodeVC.create(credential: user.phoneNo, type: .activationInsideApp(isAuth: isAuth), countryKey: "")
